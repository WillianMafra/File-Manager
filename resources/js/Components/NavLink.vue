...
const classes = computed(() =>
    props.active
        ? 'flex items-center px-5 py-2 rounded-lg border-indigo-400 text-sm font-medium leading-5 text-blue-700 bg-blue-200 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
